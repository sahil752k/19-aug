  ...
  return (
    <div className="bg-white flex flex-col items-center justify-start h-[1123px] w-[794px] mx-auto overflow-hidden p-8">
      <div className="w-full max-w-[730px] border-[5px] border-[#1d1d1b] bg-white text-[#1d1d1b] font-times relative mt-4">
        <div className="flex flex-col items-stretch min-h-[320px] pb-2">
          ...
          <div className="flex border-b-[3px] border-[#1d1d1b] items-stretch h-[105px]">
            ...
            <div className="flex-1 flex items-center justify-end min-w-0 pr-3">
                <h2 className="text-[22px] font-bold text-[#e13226] tracking-widest mt-1 shrink-0">RECEIPT</h2>
            </div>
          ...
          {/* Body */}
          <div className="py-4 px-10 text-[17px] text-[#1d1d1b] flex-1 flex flex-col justify-between">
