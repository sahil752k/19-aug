...
import { User, Zap, FileText, Calendar, CheckCircle2, ThumbsUp, Medal, Clock, Settings, HeadphonesIcon, TrendingUp, ShieldCheck, Leaf, FileCheck, CircleDot, Banknote, Building2, CreditCard, QrCode, Phone, Mail, MapPin } from 'lucide-react';
  ...
  return (
    <div className="font-times text-sm text-gray-900 bg-gray-100 py-8 print:py-0 print:bg-white flex flex-col items-center select-none">
      ...
      <PageWrapper>
        ...
        <div className="p-10 font-times flex-1 flex flex-col">
      ...
      <PageWrapper>
        ...
        <div className="p-10 font-times flex-1 flex flex-col h-full overflow-hidden">
      ...
      <PageWrapper>
        {(() => {
          const dailyVal = parseFloat(String(data.dailyGeneration || '').replace(/[^0-9.]/g, ''));
          const displayMonthly = data.monthlyGeneration || (!isNaN(dailyVal) && dailyVal > 0 ? (dailyVal * 30).toString() : '360');
          const displayYearly = data.yearlyGeneration || (!isNaN(dailyVal) && dailyVal > 0 ? (dailyVal * 365).toString() : '4380');

          const sav1Val = parseFloat(String(data.savings1Year || '').replace(/[^0-9.]/g, ''));
          const displaySav5 = data.savings5Years || (!isNaN(sav1Val) && sav1Val > 0 ? (sav1Val * 5).toLocaleString('en-IN') : '1,75,000');
          const displaySav10 = data.savings10Years || (!isNaN(sav1Val) && sav1Val > 0 ? (sav1Val * 10).toLocaleString('en-IN') : '3,50,000');
          const displaySav25 = data.savings25Years || (!isNaN(sav1Val) && sav1Val > 0 ? (sav1Val * 25).toLocaleString('en-IN') : '8,75,000');
          ...
          return (
            <>
              ...
              <div className="p-10 font-times flex-1 flex flex-row gap-8">
                 <div className="flex-1 flex flex-col">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-10">
                       ...
                       <div className="border border-gray-200 rounded-lg p-4 flex flex-col items-center pb-6">
                          ...
                          <p className="text-3xl border-t border-gray-300 w-full text-center pt-2 font-bold text-[#1e3a5f]">{displayMonthly}</p>
                          <p className="text-sm text-gray-500 mt-1">Units</p>
                       </div>
                       <div className="border border-gray-200 rounded-lg p-4 flex flex-col items-center pb-6">
                          ...
                          <p className="text-3xl border-t border-gray-300 w-full text-center pt-2 font-bold text-[#1e3a5f]">{displayYearly}</p>
                          <p className="text-sm text-gray-500 mt-1">Units</p>
                       </div>
                    </div>
                    ...
                    <table className="w-full text-center border overflow-hidden rounded-lg mb-auto">
                       ...
                       <tbody className="divide-y divide-gray-200">
                          ...
                          <tr>
                             ...
                             <td className="py-3 px-4 font-bold text-gray-800 bg-gray-50">₹ {displaySav5}</td>
                          </tr>
                          <tr>
                             <td className="py-3 px-4 bg-[#1e3a5f] text-white font-medium border-r border-[#2a4d7d]">10 Years</td>
                             <td className="py-3 px-4 font-bold text-gray-800 bg-gray-50">₹ {displaySav10}</td>
                          </tr>
                          <tr>
                             <td className="py-3 px-4 bg-[#1e3a5f] text-white font-medium border-r border-[#2a4d7d]">25 Years</td>
                             <td className="py-3 px-4 font-bold text-gray-800 bg-gray-50">₹ {displaySav25}</td>
                          </tr>
                       </tbody>
                    </table>
      ...
      <PageWrapper>
        <div className="bg-[#1e3a5f] text-white p-10 py-12 relative overflow-hidden flex items-center min-h-[140px]">
          <div className="absolute right-0 bottom-0 w-[400px] h-[300px] bg-[#e27d28] -skew-x-[35deg] translate-x-[250px] origin-bottom-right"></div>
          <div className="relative z-10 w-full flex justify-between items-center">
            <h2 className="text-4xl font-bold tracking-widest text-white">BANK DETAILS</h2>
            <div className="bg-white text-[#e27d28] font-bold py-1 px-4 rounded-full text-xs shadow-md">Page 8</div>
          </div>
        </div>

        <div className="p-10 font-times flex-1 flex flex-col justify-between">
          
          {/* Top Section: Bank Account Card & QR Scan Card */}
          <div className="grid grid-cols-[1.25fr_0.75fr] gap-6">
            
            {/* Bank Account Details */}
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
              <div className="bg-[#1e3a5f] text-white p-3.5 px-5 font-bold tracking-wider text-sm flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Building2 size={18} className="text-[#e27d28]" />
                  <span>OFFICIAL BANK ACCOUNT</span>
                </div>
                <CreditCard size={18} className="text-[#a8c6e6]" />
              </div>
              
              <div className="p-5 flex-1 flex flex-col justify-between space-y-2.5">
                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">Account Name</span>
                  <span className="font-semibold text-[#1e3a5f] text-[13px] text-right">r. s. bhandari Solar Energy Solutions</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">Bank Name</span>
                  <span className="font-semibold text-gray-900 text-[13px]">State Bank of India (SBI)</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">Account Number</span>
                  <span className="font-semibold text-gray-900 text-[13px] tracking-wider">37748474127</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">IFSC Code</span>
                  <span className="font-semibold text-gray-900 text-[13px] tracking-wider">SBIN0000503</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">Branch Name</span>
                  <span className="font-semibold text-gray-900 text-[13px] text-right">Patni Chowk, Washim - 444 505</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">Account Type</span>
                  <span className="font-semibold text-gray-900 text-[13px]">Current Account</span>
                </div>

                <div className="flex justify-between items-center border-b border-gray-100 pb-2">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">PAN Card</span>
                  <span className="font-semibold text-gray-900 text-[13px] tracking-wider">BXPPB1277F</span>
                </div>

                <div className="flex justify-between items-center pb-1">
                  <span className="font-bold text-gray-600 uppercase tracking-wider text-[13px]">GSTIN No.</span>
                  <span className="font-semibold text-gray-900 text-[13px] tracking-wider">27BXPPB1277F1ZG</span>
                </div>
              </div>
            </div>

            {/* QR Code & Digital Payments */}
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col items-center text-center">
              <div className="bg-[#e27d28] text-white p-3.5 font-bold tracking-wider text-sm w-full flex items-center justify-center gap-2">
                <QrCode size={18} />
                <span>SCAN TO PAY</span>
              </div>
              
              <div className="p-5 flex-1 flex flex-col items-center justify-between w-full">
                <div className="bg-white p-3 rounded-2xl border border-gray-200 shadow-sm">
                  <img 
                    src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://wa.me/919422939036" 
                    alt="QR Code" 
                ...
                <div className="mt-2">
                  <span className="inline-block bg-[#1e3a5f] text-white text-[12px] font-bold px-4 py-1 rounded-full uppercase tracking-wider shadow-sm">
                    Instant Bank / UPI
                  </span>
                  <p className="text-[12px] text-gray-600 font-medium mt-1.5">GPay | PhonePe | Paytm | BHIM</p>
                  <p className="text-[13px] font-semibold text-[#1e3a5f] mt-1">9422939036@ybl</p>
                </div>

                <div className="w-full border-t border-gray-200 pt-2.5 mt-2">
                  <p className="text-[12px] font-semibold text-gray-600">Accepted Payment Modes</p>
                  <p className="text-[12px] font-semibold text-[#e27d28] tracking-wide mt-0.5">NEFT • RTGS • IMPS • UPI • CHEQUE</p>
                </div>
              </div>
            </div>
          ...
          {/* Middle Section: Contact & Offices (Expanded to fill space) */}
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden my-3">
            <div className="bg-[#1e3a5f] text-white p-3.5 px-5 font-bold tracking-wider text-sm flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span>OFFICE LOCATIONS & SUPPORT DIRECTORY</span>
              </div>
              <span className="text-[11px] font-medium text-orange-200 uppercase tracking-widest">Support: Mon - Sat (9:30 AM - 6:30 PM)</span>
            </div>
            
            <div className="p-5 grid grid-cols-2 gap-6 text-[13px]">
              {/* Head Office */}
              <div className="flex flex-col justify-between border-r border-gray-200 pr-5 space-y-3">
                <div className="flex gap-3 items-start">
                  <div className="bg-orange-100 text-[#e27d28] p-2.5 rounded-full shrink-0 mt-0.5">
                    <Building2 size={20} />
                  </div>
                  <div>
                    <h4 className="font-bold text-[#1e3a5f] uppercase tracking-wider text-[13px] mb-1">Corporate & Head Office</h4>
                    <p className="text-gray-700 font-medium leading-relaxed">
                      "SAMAYSAR" Jain Colony, Pusad Naka,<br/>
                      Washim, Maharashtra - 444 505
                    </p>
                  </div>
                </div>
                
                <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 space-y-1.5 text-[12px]">
                  <div className="flex items-center gap-2 font-semibold text-[#1e3a5f]">
                    <Phone size={14} className="text-[#e27d28]" />
                    <span>+91 942 293 9036 / +91 922 637 2787</span>
                  </div>
              ...
              {/* Branch Office */}
              <div className="flex flex-col justify-between pl-2 space-y-3">
                <div className="flex gap-3 items-start">
                  <div className="bg-blue-100 text-[#1e3a5f] p-2.5 rounded-full shrink-0 mt-0.5">
                    <MapPin size={20} />
                  </div>
                  <div>
                    <h4 className="font-bold text-[#1e3a5f] uppercase tracking-wider text-[13px] mb-1">Branch Office (Pune Region)</h4>
                    <p className="text-gray-700 font-medium leading-relaxed">
                      A11, 304, Saffron, Meghapolic Rajiv Gandhi Infotech Park Phase 3,<br/>
          ...
          {/* Bottom Section: Payment Instructions (Expanded to fill space) */}
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
            <div className="bg-[#1e3a5f] text-white p-3.5 px-5 font-bold tracking-wider text-sm flex items-center justify-between">
              <div className="flex items-center gap-2">
                <ShieldCheck size={18} className="text-[#e27d28]" />
                <span>PAYMENT INSTRUCTIONS & GUIDELINES</span>
              </div>
              <span className="text-[11px] font-medium text-orange-200 uppercase tracking-widest">Important Notice</span>
            </div>

            <div className="p-5 grid grid-cols-2 gap-6 text-[13px] bg-gradient-to-br from-gray-50/50 via-white to-orange-50/30">
              {/* Column 1 */}
              <div className="space-y-3 border-r border-gray-200 pr-5">
                <div className="flex items-start gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-[#e27d28] shrink-0 mt-2"></div>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Reference Narration:</strong> Please mention Customer Name (<strong>{data.name || 'Customer'}</strong>) and Consumer Number in payment remarks while transferring.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-[#e27d28] shrink-0 mt-2"></div>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Beneficiary Name:</strong> Ensure the beneficiary is strictly named <strong>"r. s. bhandari Solar Energy Solutions"</strong> before approving RTGS/NEFT.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 pl-2">
                <div className="flex items-start gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-[#1e3a5f] shrink-0 mt-2"></div>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Payment Confirmation:</strong> Share payment screenshot / UTR number via WhatsApp at <strong>+91 942 293 9036</strong> for immediate receipt acknowledgment.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2.5">
                  <div className="w-2 h-2 rounded-full bg-[#1e3a5f] shrink-0 mt-2"></div>
                  <p className="text-gray-700 leading-relaxed">
                    <strong>Official Receipt:</strong> Computerized tax invoice & official receipt will be issued within 24 hours of bank clearance.
                  </p>
                </div>
              </div>
            </div>
