...
export const DataForm: React.FC<Props> = ({ onNext }) => {
  ...
  const handleSignatureUpload = (e: React.ChangeEvent<HTMLInputElement>, type: string) => {
    const file = e.target.files?.[0];
    if (file) {
      const reader = new FileReader();
      reader.onloadend = () => {
    ...
    >
          ...
          {activeTab === 'Model Agreement' && (
            <motion.div 
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-shadow duration-300">
                 <h4 className="text-xs tracking-[0.25em] font-black text-gray-400 mb-8 flex items-center gap-3">
                    <span className="w-6 h-6 rounded-lg bg-gray-100 flex items-center justify-center border border-gray-200"><div className="w-2 h-2 bg-gray-500 rounded-full shadow-[0_0_8px_#6b7280]"></div></span> 
                    SIGNATURES
                 </h4>
                 <div className="grid grid-cols-1 gap-6">
                 <SignatureField label="Customer Signature" dataKey="maCustomerSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 <SignatureField label="Witness Signature" dataKey="maWitnessSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 </div>
               </div>
</motion.div>
          )}
            ...
            <motion.div 
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                 <SignatureField label="Customer Signature" dataKey="a1CustomerSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 </div>
               </div>
</motion.div>
          )}
            ...
            <motion.div 
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                 <SignatureField label="Customer Signature" dataKey="a3CustomerSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 <SignatureField label="Vendor Signature" dataKey="a3VendorSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 <SignatureField label="Witness Signature" dataKey="a3WitnessSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 </div>
               </div>
</motion.div>
          )}
            ...
            <motion.div 
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                 <SignatureField label="Customer Signature" dataKey="wcrCustomerSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 </div>
               </div>
</motion.div>
          )}
            ...
            <motion.div 
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                 <SignatureField label="Vendor Signature" dataKey="receiptVendorSignature" data={data} onUpload={handleSignatureUpload} onDraw={setDrawingFor} />
                 </div>
               </div>
</motion.div>
          )}
      ...
      {drawingFor && (
        <SignatureDrawer
          ...
          onSave={(dataUrl) => {
            setData((prev) => ({ ...prev, [drawingFor]: dataUrl }));
            setDrawingFor(null);
          }}
