...
# We need to replace the entire content inside `activeTab === 'Proposal'` block
             ...
             >
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 gap-y-10">
                    ...
                    {renderField('System Size (kW)', 'installedCapacity', 'number', '', 3)}
                 </div>
               </div>
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 gap-y-10">
                    {renderField('Type of Module', 'moduleType', 'text', '', 0)}
                    ...
                    {renderField('Structure', 'structure', 'text', '', 7)}
                    {renderField('Subsidy Amount (₹)', 'subsidyAmount', 'number', '', 8)}
                    {renderField('Total System Cost (₹)', 'totalCost', 'number', '', 9)}
                 </div>
               </div>
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 gap-y-10">
                    {renderField('Module Make', 'moduleMake', 'text', '', 0)}
                    {renderField('No. of Modules', 'numberOfModules', 'number', '', 1)}
                    {renderField('Module Wattage (Wp)', 'moduleWattage', 'number', '', 2)}
                    {renderField('Inverter Make', 'inverterMake', 'text', '', 3)}
                    {renderField('Inverter Capacity (kW)', 'inverterCapacity', 'number', '', 4)}
                 </div>
               </div>
               ...
               <div className="bg-gradient-to-b from-gray-50/50 to-white p-8 rounded-[2rem] border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 gap-y-10">
                    ...
                    {renderField('Proposal Date', 'proposalDate', 'date', '', 5)}
                    {renderField('Quote Validity (Days)', 'quoteValidity', 'text', '', 6)}
                 </div>
               </div>
             </motion.div>
          )}
