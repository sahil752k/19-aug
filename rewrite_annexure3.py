    ...
    <div className="bg-gray-200 py-8 print:py-0 print:bg-white flex justify-center">
      ...
      <div className="annexure3-container">
        ...
        <div className="a4-page">
          <h2 className="text-center text-[20px] mb-6 mt-4">ANNEXURE &ndash; 3</h2>
          <h3 className="text-center font-bold mb-4 leading-snug text-[15px]">
        ...
        <div className="a4-page">
          ...
          <div className="grid grid-cols-2 gap-y-12 pl-[34px] relative">
            <div>
              <div className="h-[60px] w-48 mb-1 flex flex-col items-start justify-end">
                {data.customerSignature ? (
                  <img src={data.customerSignature} alt="Signature" className="w-48 h-[60px] object-contain object-left mix-blend-multiply" />
                ) : (
            ...
            <div>
              <div className="h-[60px] w-48 mb-1 flex flex-col items-start justify-end">
                 {data.witnessSignature ? (
                  <img src={data.witnessSignature} alt="Witness 1 Signature" className="w-48 h-[60px] object-contain object-left mix-blend-multiply" />
                 ) : (
            ...
            <div>
              <div className="h-[60px] w-48 mb-1 flex flex-col items-start justify-end">
                 {data.vendorSignature ? (
                  <img src={data.vendorSignature} alt="Witness 2 Signature" className="w-48 h-[60px] object-contain object-left mix-blend-multiply" />
                 ) : (
            ...
            {/* PAGE 3 STAMP: Positioned at bottom left overlapping the witness signature text */}
